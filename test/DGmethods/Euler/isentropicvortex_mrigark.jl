...
function main()
    ...
    expected_error = Dict()
    expected_error[Float64, MRIGARKERK33aSandu, 1] = 2.3357905305579504e+01
    expected_error[Float64, MRIGARKERK33aSandu, 2] = 5.3328144574142629e+00
    expected_error[Float64, MRIGARKERK33aSandu, 3] = 1.2991270301981200e-01
    expected_error[Float64, MRIGARKERK33aSandu, 4] = 6.1055886170643591e-03
    expected_error[Float64, MRIGARKERK45aSandu, 1] = 2.3207479805495986e+01
    expected_error[Float64, MRIGARKERK45aSandu, 2] = 5.2787492385116144e+00
    expected_error[Float64, MRIGARKERK45aSandu, 3] = 1.2151222668954006e-01
    expected_error[Float64, MRIGARKERK45aSandu, 4] = 2.1001219876502727e-03
