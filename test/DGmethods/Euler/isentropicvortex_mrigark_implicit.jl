...
using CLIMA.Mesh.Grids: DiscontinuousSpectralElementGrid, VerticalDirection, HorizontalDirection
...
function main()
    ...
    expected_error = Dict()
    expected_error[Float64, MRIGARKIRK21aSandu, 1] = 2.3357905305579504e+01
    expected_error[Float64, MRIGARKIRK21aSandu, 2] = 5.3328144574142629e+00
    expected_error[Float64, MRIGARKIRK21aSandu, 3] = 1.2991270301981200e-01
    expected_error[Float64, MRIGARKIRK21aSandu, 4] = 6.1055886170643591e-03
    expected_error[Float64, MRIGARKIRK21aSandu, 1] = 2.3207479805495986e+01
    expected_error[Float64, MRIGARKIRK21aSandu, 2] = 5.2787492385116144e+00
    expected_error[Float64, MRIGARKIRK21aSandu, 3] = 1.2151222668954006e-01
    expected_error[Float64, MRIGARKIRK21aSandu, 4] = 2.1001219876502727e-03

    @testset "$(@__FILE__)" begin
        for FT in (Float64,), dims in 2
            for mrigark_method in (MRIGARKIRK21aSandu,)
                ...
                for level in 1:numlevels
                    ...
                    # @test errors[level] ≈ expected_error[FT, mrigark_method, level]
                end
...
function run(
    ...
    # Explicit treatment of horizontal acoustic waves
    # in fast solver
    fast_dg = DGModel(
        fast_model,
        grid,
    ...
    # Implicit treatment of vertical acoustic waves to
    # be included in the outer "slow" solver
    lineardg = DGModel(
        fast_model,
        grid,
        Rusanov(),
    ...
    ode_solver = mrigark_method(slow_dg, lineardg, linearsolver, fastsolver, Q, dt = slow_dt)
...
function do_output(
    ...
    Qe,
    model,
    testname = "isentropicvortex_mrigark_implicit",
)
